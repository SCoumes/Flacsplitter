...
# Define variables
EXECUTABLE_NAME="Flacsplitter"
EXECUTABLE_FILE="Flacsplitter"
ICON_NAME="flacsplitter"
ICON_FILE="flacsplitter.png"
...
EXECUTABLE_DIR="$USER_HOME/.local/share/flacsplitter"

...
if platform.system() == "Windows":
    windows_build_dir = os.path.join("dist","Flacsplitter_v1.0_windows")
    ...
    PyInstaller.__main__.run([
        ...
        "--name",
        "Flacsplitter",
        "--icon=flacsplitter.ico"
    ])
    # Create a zip file containing the executable and other relevant files for the windows build
    os.makedirs(windows_build_dir)
    shutil.copy(os.path.join("dist","Flacsplitter.exe"), windows_build_dir)
    shutil.copy("flacsplitter.png", windows_build_dir)
...
# Build on linux
    ...
    linux_build_dir = os.path.join("dist","Flacsplitter_v1.0_linux")
    ...
    shutil.copy(os.path.join("dist","Flacsplitter"), linux_build_dir)
    shutil.copy("flacsplitter.png", linux_build_dir)
